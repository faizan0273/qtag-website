...
/**
 * Catalogue SKUs: checkout resolves price and tag count server-side only.
 */
...
/** Standard capability grid (privacy first QR relay). */
const STANDARD_MATRIX: ShopCatalogEntry['matrixRows'] = [
  ...
  },
  {
    ...
    cells: ['Mute or disable tag', 'Lost mode', 'Rate limits', 'Online checkout'],
  },
  {
...
export const SHOP_CATALOG: ShopCatalogEntry[] = [
  {
    ...
    summary:
      'Camera scan opens your Qtag relay page. They message you on WhatsApp; your phone stays private.',
    pricePkr: 399,
    compareAtPkr: 749,
    offers: [
    ...
    story: [
      'Designed for apartment lots, street parking, and malls, when someone needs you about parking, access, or a safety note, they scan once and reach you safely.',
      'Works with the same Qtag activation flow you already use: scan, verify, and your tag is live.',
    ],
    tagsPerPack: 1,
  ...
  },
  {
    ...
    highlights: [
      'Pairs with Qtag dashboard controls',
  ...
  },
  {
    ...
    summary:
      'If the bike is moved or the helmet is left behind, a scan still opens the Qtag relay, helpful in cities and campus parking.',
    pricePkr: 499,
    compareAtPkr: 899,
    offers: [
  ...
  },
  {
    ...
    summary:
      'A physical card people can photograph, your Qtag backed profile keeps the conversation organized and your personal number optional.',
    pricePkr: 599,
    compareAtPkr: 1299,
    offers: [
      'Professional scan to contact flow',
      'Great for shops, riders, and freelancers',
      'Editable from Qtag dashboard',
      'Nationwide delivery',
    ],
    matrixRows: STANDARD_MATRIX,
    specs: [
  ...
  },
  {
    ...
    summary:
      'Two tags for gate and door, scan opens your relay so guests or riders can WhatsApp you quietly with context.',
    pricePkr: 499,
    compareAtPkr: 999,
    offers: [
  ...
  },
  {
    ...
    summary:
      'One keyring tag plus four adhesive labels: same Qtag relay, optimised for whatever moves with you every day.',
    pricePkr: 499,
    compareAtPkr: 999,
    offers: [
